...
import com.generatiom.blogpessoal.repository.UsuarioRepository;
import com.generatiom.blogpessoal.service.UsuarioService;
...
public class UsuarioControllerTest {
    ...
    public void deveAtualizarUmUsuario() {
        ...
        Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, "Juliana Andrews",
        		"https://i.imgur.com/yDRVeK7.jpg%22","juliana_andrew@email.com.br", "juliana123" ));
    ...
    public void deveMostrarTodosUsuarios() {
        usuarioService.cadastrarUsuario(new Usuario(0L, "Sabrina Sanches","https://i.imgur.com/EcJG8k8.jpg%22","sabrina_sanches@email.com.br", "sabrina123"));
        usuarioService.cadastrarUsuario(new Usuario(0L, "Ricardo Marques","https://i.imgur.com/Sk5sjWE.jpg%22","ricardo_marques@email.com.br", "ricardo123"));
